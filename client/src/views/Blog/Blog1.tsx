...
const Blog = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta property="og:image" content="https://media.discordapp.net/attachments/1197467042886996018/1211595490140102756/X_BLUCKA_BULL.jpg?ex=65eec53b&is=65dc503b&hm=f4e76ff480b9731b3ce841de809d596853d580fbea31a1a74e3e71d17134a698&=&format=webp&width=2268&height=1064" />
        ...
        <meta name="twitter:image" content="https://media.discordapp.net/attachments/1197467042886996018/1211595490140102756/X_BLUCKA_BULL.jpg?ex=65eec53b&is=65dc503b&hm=f4e76ff480b9731b3ce841de809d596853d580fbea31a1a74e3e71d17134a698&=&format=webp&width=2268&height=1064" />
            ...
            <div className="max-w-8xl justify-center items-center mx-auto px-4 sm:px-12 md:px-16 lg:px-[300px] flex flex-col">
                ...
                <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                    <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue ">
                        <figure className="mb-4 item-center"><img src="https://media.discordapp.net/attachments/1197467042886996018/1211595490140102756/X_BLUCKA_BULL.jpg?ex=65eec53b&is=65dc503b&hm=f4e76ff480b9731b3ce841de809d596853d580fbea31a1a74e3e71d17134a698&=&format=webp&width=2268&height=1064" alt="Thumbnail"/>
