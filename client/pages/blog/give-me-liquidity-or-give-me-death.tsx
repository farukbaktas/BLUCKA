...
const Blog = () => {
  ...
  return (
    ...
    <Head>
        ...
        <meta property="og:image" content={BannerIMG.src} />
        ...
        <meta name="twitter:image" content={BannerIMG.src} />
        {/* Extra Meta */}
            ...
            <div className="max-w-8xl justify-center items-center mx-auto px-4 sm:px-12 md:px-16 lg:px-[300px] flex flex-col">
                ...
                <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
                    <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue ">
                        <figure className="mb-4 item-center"><Image src={BannerIMG} alt="Thumbnail"/>
                        ...
                        <header className="mb-4 lg:mb-6 not-format">
                            <address className="flex items-center mb-6 not-italic">
                                ...
                                <Image className="mr-4 w-16 h-16 rounded-full" src={PP} alt="BLUCKA PP"/>
                                    <div>
