            ...
            <form onSubmit={sendEmail} className="space-y-8">
              <div className="">
                ...
                <input
                  ...
                  name="user_name"
                  id="name"
                  className="custom-shear shadow-sm bg-gray-50 border border-gray-300 text-black text-sm focus:ring-black focus:border-black block w-full p-2.5"
              ...
              <div className="">
                ...
                <input
                  ...
                  name="website"
                  id="website"
                  className="custom-shear block p-3 w-full text-sm text-black bg-gray-50 border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 "
                  placeholder="https://blucka.com"
                  required
                />
              </div>
              <div className="sm:col-span-2">
                ...
                <textarea
                  id="message"
                  name="message"
                  className="custom-shear block p-2.5 w-full text-sm text-black bg-gray-50 shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 "
              ...
              <div className="custom-shear mt-4">
                <button
                  type="submit"
                  className="bg-white text-black font-bold py-2 px-8"
                >
                  Send message!
                </button>
              </div>
