...
const Down = () => {
  return (
    <div className='bg-black text-black'>
        <div className="fixed w-full bottom-0 left-0 custom-shear max-w-8xl mx-auto px-32">
            <div className="flex items-end space-x-16 justify-center">
                <div className="flex space-x-4 item-end justify-end text-white">
                    {/*Mail*/}
                    <a href='x.com' className="w-8 h-8">
                ...
                <div className='flex items-end space-x-16 pl-72'>
                    <HighlightedText text="Services" />
                    <div className="flex flex-col items-start ">
                        <HighlightedText text="Consulting" />
                        <HighlightedText text="Web3 Campaign" />
                        <HighlightedText text="Content Creation" />
                        <HighlightedText text="Marketing Strategies" />
                        <HighlightedText text="Community Building" />
                        <HighlightedText text="Brand Design" />
