    ...
    <div className="bg-black  text-black">
        <div className="fixed justify-center items-center w-full bottom-0 left-0 custom-shear max-w-8xl mx-auto px-4 sm:px-8 md:px-16 lg:px-32">
            <div className="bg-black flex flex-col sm:flex-row  items-center sm:items-end space-y-4 sm:space-y-0 sm:space-x-16 justify-center">
                <Link to="/contact" className='text-[18px] sm:text-[18px] md:text-[20px] lg:text-lg mb-4 sm:mb-2'>
                    <HighlightedTextDark text="> Contact Us <" />
                </Link>
                <div className="flex space-x-8 sm:mt-40 items-center justify-center text-black">
                    {/*X*/}
                    <a href='https://twitter.com/blucka_agency' className="w-7 h-7 ">
                    ...
                    {/*Discord*/}
                    <a href='https://discord.gg/yPe4bcv7P5' className="w-8 h-8">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/*Linkedin*/}
                    <a href='https://www.linkedin.com/company/bluckaai/' className="w-7 h-7 ">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
